...
export default function PostCard(props: {
  ...
  return (
    <Link href={`/p/${props.id}?type=${props.type}`}>
      <div
        style={{
          borderImage: 'linear-gradient(135deg, #b4b4b9, #3b3b40) 1',
        }}
        className="w-159 h-225 lg:w-453 lg:h-640 border-solid border-[1px] lg:border-[2px] lg:p-7 bg-[#E4E7EF] p-2 mb-9 lg:mb-14 shrink-0 shadow-[inset_0px_0px_1px_1px_#00000040]"
      >
        <img
          alt=""
