...
export default function UserProfile(props: UserProfileProps) {
  ...
  const redirectToApp = () => {
    ...
    window.location.href = 'com.reverie://user?id=' + uid
  }
        ...
        <div className="user-infos w-full flex justify-between lg:justify-start">
          <div className="circle-avatar w-120 lg:w-280 relative top-[-60px] lg:top-[-140px]">
            <div
              ...
              className="border-[2px] w-118 h-118 lg:w-280 lg:h-280 lg:border-[10px] border-solid border-[#cfd1d4] lg:border-[#E4E7EF] rounded-full"
            >
              <img
            ...
            <div
              onClick={showPopupFunc}
              className="likes-and-remixes-number text-center mt-12 lg:mt-[32px] flex justify-between text-[#434348] text-[15px] leading-[18px] font-bold lg:text-[32px] lg:leading-[38px]"
            >
              <div>
          ...
          <div className="user-descriptions w-181 lg:w-753 lg:ml-120 lg:pt-60 pt-16">
            <p
              onClick={showPopupFunc}
              className="text-[16px] leading-[19px] lg:text-[48px] lg:leading-[57px] mb-12 lg:mb-[24px] tracking-[1px]"
            >
              @{profile.username}
            </p>
            <div
              onClick={showPopupFunc}
              className="h-72 lg:h-90 overflow-y-auto custom-scroll-bar"
            >
